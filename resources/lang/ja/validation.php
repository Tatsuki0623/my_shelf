    ...
    */
    ...
    'custom' => [
        'ReadTime.read_time' => [
            ...
            'integer' => '先頭に0を付けるなどのことをすると正しく認識できないため1～24の値で入力してください。*　✕08　〇8',
            ],
        'book.title' => [
            'required' => '本のタイトルを入力してください',
            'max' => '100文字以下で入力してください',
        ],
        'book.impression' => [
            'max' => '600文字以下で入力してください',
        ],
        'book.point' => [
            'required' => '数値を入力してください',
            'integer' => '先頭に0を付けるなどのことをすると正しく認識できないため1～24の値で入力してください。*　✕08　〇8',
            'between' => '1～100の数値を入力してください',
        ],
        'book.volume' =>[
            'required' => '数値を入力してください',
            'integer' => '先頭に0を付けるなどのことをすると正しく認識できないため1～24の値で入力してください。*　✕08　〇8',
        ...
        'book.isbn' =>[
            'required' => '数値を入力してください',
            'between' => '10～13桁で入力してください',
            ],
        'memo.title' => [
            'required' => 'メモのタイトルを入力してください',
            'max' => '100文字以下で入力してください',
        ],
        'memo.body' => [
            'required' => 'メモの本文を入力してください',
            'max' => '600文字以下で入力してください',
            ],
    ],
